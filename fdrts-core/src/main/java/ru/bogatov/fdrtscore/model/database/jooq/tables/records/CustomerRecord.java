...
public class CustomerRecord extends TableRecordImpl<CustomerRecord> implements Record14<UUID, String, String, String, Boolean, LocalDate, String, String, String, Integer, String, Integer, Float, Float> {
    ...
    @Override
    public Row14<UUID, String, String, String, Boolean, LocalDate, String, String, String, Integer, String, Integer, Float, Float> valuesRow() {
    ...
    @Override
    public CustomerRecord values(UUID value1, String value2, String value3, String value4, Boolean value5, LocalDate value6, String value7, String value8, String value9, Integer value10, String value11, Integer value12, Float value13, Float value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CustomerRecord(UUID id, String ccNum, String firstName, String lastName, Boolean gender, LocalDate birthday, String street, String city, String state, Integer zip, String job, Integer cityPop, Float lat, Float long_) {
        super(Customer.CUSTOMER);
     ...
     * Create a detached, initialised CustomerRecord
     */
    public CustomerRecord(ru.bogatov.fdrtcore.model.database.jooq.tables.pojos.Customer value) {
        super(Customer.CUSTOMER);
