...
public class Merchant extends TableImpl<MerchantRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function4<? super UUID, ? super String, ? super Float, ? super Float, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function4<? super UUID, ? super String, ? super Float, ? super Float, ? extends U> from) {
