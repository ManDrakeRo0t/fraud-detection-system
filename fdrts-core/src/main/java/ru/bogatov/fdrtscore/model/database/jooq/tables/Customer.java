...
public class Customer extends TableImpl<CustomerRecord> {
    ...
    /**
     * The column <code>public.customer.migrated</code>.
     */
    public final TableField<CustomerRecord, Boolean> MIGRATED = createField(DSL.name("migrated"), SQLDataType.BOOLEAN, this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function15<? super UUID, ? super String, ? super String, ? super String, ? super Boolean, ? super LocalDate, ? super String, ? super String, ? super String, ? super Integer, ? super String, ? super Integer, ? super Float, ? super Float, ? super Boolean, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function15<? super UUID, ? super String, ? super String, ? super String, ? super Boolean, ? super LocalDate, ? super String, ? super String, ? super String, ? super Integer, ? super String, ? super Integer, ? super Float, ? super Float, ? super Boolean, ? extends U> from) {
